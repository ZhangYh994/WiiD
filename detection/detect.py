...
def parse_opt():
    ...
    parser.add_argument(
        "--weights", nargs="+", type=str, default=ROOT / "weights/yolov5m.pt", help="model path or triton URL"
    )
    parser.add_argument("--source", type=str, default=ROOT / "datasets/Exdark/val/images", help="file/dir/URL/glob/screen/0(webcam)")
    parser.add_argument("--data", type=str, default=ROOT / "data/Exdark_test.yaml", help="(optional) dataset.yaml path")
