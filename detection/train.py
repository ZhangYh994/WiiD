...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if opt.multi_val:
        train_path, val_path, val2_path = data_dict["train"], data_dict["val"], data_dict["val2"]
    else:
...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/Exdark_dev.yaml", help="dataset.yaml path")
    ...
    parser.add_argument("--multi_val", action="store_true", help="if use multi val datasets")
